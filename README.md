...
2. Run the Container
Start the container in detached mode. This example maps the container's internal port 8080 to your machine's port 2000.
...
In your VS Code or terminal, create a new file named README.md.

Paste the text above into it.

Save the file.

Run these commands to add it to your repo:
